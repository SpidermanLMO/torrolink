...
echo Committing...
%GIT% commit -m "Security + fixes: profile.js try/catch, ToS checkbox, referral referred_by, billing-agent base64, portal-save ownership hardening, track-action size limit"
