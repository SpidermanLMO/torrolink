...
```
SUPABASE_URL          = [your Supabase project URL — in Supabase dashboard → Settings → API]
...
- Supabase: [see Supabase dashboard — never commit project URLs]
...
- Supabase project URL: [see Supabase dashboard — never commit project URLs]
